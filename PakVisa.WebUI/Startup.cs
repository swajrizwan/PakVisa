...
namespace PakVisa.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPakVisaRepository, PakVisaRepository>();
            services.AddTransient<PakVisaSeeder>();
        ...
        public void Configure(IApplicationBuilder app, PakVisaSeeder seeder)
        {
